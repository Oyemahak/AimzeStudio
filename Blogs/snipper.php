<?php
/**
 * Aimze Studio — Our Blogs archive (final with spacing + blue mobile band)
 */
add_action('wp_enqueue_scripts', function () {
    ...
    $blue = '#dbeafe';   // soft blue strip above the lilac band
    $lilac = '#f2f0fe';  // existing safe band color
...
@media (max-width: 767px) {
    /* BLUE band sits above lilac (total negative stack = 170px) */
    .blog .ast-archive-entry-banner::after {
        top: -170px;
        height: 40px;
        background: {$blue};
    ...
    /* LILAC band directly below the blue */
    .blog .ast-archive-entry-banner::before {
        top: -130px;
        height: 130px;
        background: {$lilac};
